...
#line 172 "src\\auto\\XSTools\\win32\\wrapper.c"
...
#line 30 "src\\\\auto\\\\XSTools\\\\win32\\\\wrapper.xs"
		char *op = NULL;
#line 231 "src\\auto\\XSTools\\win32\\wrapper.c"
...
#line 236 "src\\auto\\XSTools\\win32\\wrapper.c"
	TARGi((IV)RETVAL, 1);
	ST(0) = TARG;
    }
    XSRETURN(1);
...
#line 41 "src\\\\auto\\\\XSTools\\\\win32\\\\wrapper.xs"
		HANDLE toolhelp;
		PROCESSENTRY32 pe;
#line 256 "src\\auto\\XSTools\\win32\\wrapper.c"
...
#line 275 "src\\auto\\XSTools\\win32\\wrapper.c"
	PUTBACK;
	return;
    }
}
...
#line 294 "src\\auto\\XSTools\\win32\\wrapper.c"
    }
    XSRETURN_EMPTY;
}
...
#line 312 "src\\auto\\XSTools\\win32\\wrapper.c"
    }
    XSRETURN_EMPTY;
}
...
#line 333 "src\\auto\\XSTools\\win32\\wrapper.c"
	TARGu((UV)RETVAL, 1);
	ST(0) = TARG;
    }
    XSRETURN(1);
...
#line 138 "src\\\\auto\\\\XSTools\\\\win32\\\\wrapper.xs"
		DWORD bytesRead;
		LPVOID buffer;
#line 461 "src\\auto\\XSTools\\win32\\wrapper.c"
#line 141 "src\\\\auto\\\\XSTools\\\\win32\\\\wrapper.xs"
		...
		free(buffer);
#line 470 "src\\auto\\XSTools\\win32\\wrapper.c"
...
#line 157 "src\\\\auto\\\\XSTools\\\\win32\\\\wrapper.xs"
		...
		STRLEN dwSize;
		DWORD bytesWritten;
#line 497 "src\\auto\\XSTools\\win32\\wrapper.c"
...
#line 509 "src\\auto\\XSTools\\win32\\wrapper.c"
	TARGu((UV)RETVAL, 1);
	ST(0) = TARG;
    }
    XSRETURN(1);
...
#line 528 "src\\auto\\XSTools\\win32\\wrapper.c"
    }
    XSRETURN_EMPTY;
}
...
#line 594 "src\\auto\\XSTools\\win32\\wrapper.c"
    }
    XSRETURN_EMPTY;
}
...
#line 630 "src\\auto\\XSTools\\win32\\wrapper.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
#line 667 "src\\auto\\XSTools\\win32\\wrapper.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
#line 705 "src\\auto\\XSTools\\win32\\wrapper.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
